Those who know my preferences, I (the flosh shell project owner) have reasons to prefer C over C++, and flosh WILL be built on C / ASM / GO but I want to have fish-shell as reference source code presented here.
